...
Circle.prototype = {
    draw: function(context2d) {
        ...
        context2d.clearRect(this.oldPosition.x, this.oldPosition.y, widthHeight, widthHeight);

        context2d.beginPath();
        context2d.arc(this.position.x + halfWidth, this.position.y + halfWidth, radius, 0, 2 * Math.PI, false);
